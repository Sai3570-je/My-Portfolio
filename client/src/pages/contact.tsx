      ...
      <div className="max-w-2xl">
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-4 p-4 border border-gray-600 rounded-lg hover:border-tBlue transition-colors">
            <span className="text-tBlue">🌐</span>
            <div>
              <p className="text-tWhiteSec font-medium">Portfolio</p>
              <a href="https://sai3570-je.github.io/Sai-Portfolio/" className="text-gray-400 hover:text-tBlue transition-colors">
                sai3570-je.github.io/Sai-Portfolio
              </a>
            </div>
          </div>
